...
public class InfoFile extends DialogFragment {
  ...
  @BindView(R.id.content_file_name) TextView name;
  @BindView(R.id.content_file_from) TextView from;
  @BindView(R.id.content_file_desc) TextView desc;
  @BindView(R.id.content_sign_time) TextView time;
  @BindView(R.id.content_file_size) TextView size;
  private CallbackInfoFile callbacksendfile;
